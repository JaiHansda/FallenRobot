...
from FallenRobot import app, COMMAND_HANDLER

#----------------TOKEN------------------
TOKEN="2131967391:ZAIERX" #GET THIS TOKEN FROM @NovaXApiBot
...
async def aigen(_, message:Message):
    ...
    try:
        a = output['image_url']
        await message.reply_photo(a, caption="GENERATED BY [ALPHAxAPI](https://t.me/Alpha_x_Bots)")
        await msg.delete()
